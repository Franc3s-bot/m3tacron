...
from .cache import meta_snapshot_cache
...
@meta_snapshot_cache.decorator
def _compute_meta_snapshot(data_source: str) -> dict:
    """
    Compute the full meta-snapshot. Cached to avoid recomputation
    on every dashboard load. The data only changes when scrapers run.
    """
